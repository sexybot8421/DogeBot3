...
const starts = async (DogeXeonOP = new WAConnection()) => {
    ...
    console.log(color(figlet.textSync('Silen Bot', {
		font: 'Standard',
...
console.log(color('> WA NUMBER: +94775978468 ','silver'))
console.log(color('  SILEN Bot Inc. 2022','mediumseagreen'))
    ...
    DogeXeonOP.sendMessage(`94775978468s.whatsapp.net`, `Thanks bro, your bot is working on my whatsapp number ez😂`, MessageType.extendedText)
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      try {
        ...
        DogeXeonOP.sendMessage(anu.jid, "Hello everyone, am 𝐒𝐈𝐋𝐄𝐍 𝐁𝐎𝐓, ready to help you here ㋛︎", "conversation")
      }
      ...
      welcomeButt = { contentText: `${teks}`, footerText: `𝐒𝐈𝐋𝐄𝐍 𝐁𝐎𝐓`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `𝐒𝐈𝐋𝐄𝐍 𝐁𝐎𝐓`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
